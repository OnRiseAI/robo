  ...
  return (
    <div className={cn('flex items-center justify-center', className)}>
      <NavigationMenu viewport={false}>
        <NavigationMenuList
          className={cn(
            'flex items-center gap-0 rounded-full border-none py-2 transition-all duration-500',
            !isScrolled &&
              'border-background outline-border relative border-2 px-4 outline-1 before:absolute before:inset-0 before:-z-1 before:size-full before:rounded-full before:bg-neutral-950/5 before:backdrop-blur-sm'
          )}
        >
              ...
              return (
                <NavigationMenuItem key={navItem.title}>
                  <NavigationMenuLink
                    ...
                    className={cn(
                      navigationMenuTriggerStyle(),
                      'text-foreground/70 hover:text-foreground data-[active=true]:text-foreground focus-visible:text-foreground focus:text-foreground bg-transparent px-3! py-1.5! text-base! font-medium! shadow-none hover:bg-transparent focus:bg-transparent focus-visible:bg-transparent data-[active=true]:bg-transparent hover:data-[active=true]:bg-transparent focus:data-[active=true]:bg-transparent active:data-[active=true]:bg-transparent'
                    )}
                    asChild
                  >
            ...
            return (
              <NavigationMenuItem key={navItem.title}>
                <NavigationMenuTrigger
                  ...
                  className='text-foreground/70 focus-visible:text-foreground hover:text-foreground data-[active=true]:text-foreground! focus:text-foreground/70 bg-transparent px-3! py-1.5! text-base! font-medium! shadow-none hover:bg-transparent focus:bg-transparent focus-visible:bg-transparent data-[state=open]:bg-transparent hover:data-[state=open]:bg-transparent focus:data-[state=open]:bg-transparent [&_svg]:size-4'
                >
                  {navItem.title}
                </NavigationMenuTrigger>
                <NavigationMenuContent
                  className={cn(
                    ...
                    'bg-background/35! left-1/2 -translate-x-1/2 shadow-lg! backdrop-blur-sm!'
                  )}
                >
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <MatterButton className={cn('inline-flex lg:hidden', triggerClassName)}>
          <MenuIcon />
        ...
        <SheetHeader className='p-4'>
          ...
          <Link href='/' onClick={handleLinkClick} className='self-start'>
            <div className='flex items-center gap-3'>
              ...
              <span className='text-foreground font-[Orbitron] text-[1.75rem] leading-6.5 font-extrabold'>Matter</span>
            </div>
          </Link>
        </SheetHeader>
                  ...
                  {navItem.items?.map(item => {
                    ...
                    return (
                      <Link
                        ...
                        href={item.href}
                        data-active={isActive}
                        className='hover:bg-accent data-[active=true]:text-primary text-foreground/80 ml-3 flex items-center gap-2 rounded-sm px-3 py-2 text-sm data-[active=true]:font-medium'
                        onClick={handleLinkClick}
                      >
